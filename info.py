...
API_ID = int(environ.get('API_ID', '20227614'))
API_HASH = environ.get('API_HASH', 'b9268f7d01884a3d740ba17d0ad8754b')
BOT_TOKEN = environ.get('BOT_TOKEN', "7902373618:AAHyaw1n2bD5euuPK270L9YPZ2FkSthfpB8")


# This Pictures Is For Start Message Picture, You Can Add Multiple By Giving One Space Between Each.
PICS = (environ.get('PICS', 'https://files.catbox.moe/ayn0ls.jpg')).split()


# Admins & Users
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '6001922744').split()] # For Multiple Id Use One Space Between Each.
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002638523948'))

# This Is File Channel Where You Upload Your File Then Bot Automatically Save It In Database 
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002154476472').split()]  # For Multiple Id Use One Space Between Each.
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://razer:razer@cluster0.ejqdilu.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")   # IF Multiple Database Is False Then Fill Only This Database Url.
DATABASE_NAME = environ.get('DATABASE_NAME', "Fpopcorn")
...
# Links
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/MovieSearchgrop')
...
OWNER_LNK = environ.get('OWNER_LNK', 'https://t.me/Therazerhub')
